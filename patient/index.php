                    ...
                    <tr>
                        <td >
                            ...
                            <form action="schedule.php" method="post" style="display: flex">
                                ...
                                <input type="search" name="search" class="input-text " placeholder="Search by Specialization" list="specializations" style="width:45%;">&nbsp;&nbsp;
                                
                                <?php
                                    echo '<datalist id="specializations">';
                                    $list11 = $database->query("SELECT DISTINCT s.sname 
                                                              FROM doctor d 
